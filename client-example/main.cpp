...
int main() {
	...
	client.write("clear\n");
	client.write("color-mode dark\n");
	client.write("camera-mode planar\n");
	...
	client.write("create obj2/obj3/obj4 cuboid   material color 255 255 0   transform translation 1 0 0 geometry 0.25 0.25 0.25\n");
